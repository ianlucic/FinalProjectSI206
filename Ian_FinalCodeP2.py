...
fig.update_layout(title = title_str, xaxis_tickangle=0, barmode='group', xaxis = {'tickmode':'linear'}, font_family="Futura", font_color="black", title_font_family="Futura", title_font_color="black")
fig.show()
